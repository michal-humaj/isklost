...
// @LINE:65
private[this] lazy val controllers_Application_javascriptRoutes40_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("assets/javascripts/routes"))))
private[this] lazy val controllers_Application_javascriptRoutes40_invoker = createInvoker(
...
// @LINE:65
case controllers_Application_javascriptRoutes40_route(params) => {
   call { 
        controllers_Application_javascriptRoutes40_invoker.call(controllers.Application.javascriptRoutes())
   }
}
