...
<html>
    ...
    <body class="skin-blue">
        ...
        <script src=""""),_display_(/*86.23*/routes/*86.29*/.Application.javascriptRoutes()),format.raw/*86.60*/("""" type="text/javascript"></script>
        <script src='"""),_display_(/*87.23*/routes/*87.29*/.Assets.at("js/utils.js")),format.raw/*87.54*/("""' type="text/javascript"></script>
        """),_display_(/*88.10*/javascripts),format.raw/*88.21*/("""
