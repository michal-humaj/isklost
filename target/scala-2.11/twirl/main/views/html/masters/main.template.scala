...
<html>
    ...
    <body class="skin-blue">
        ...
        <script src='"""),_display_(/*86.23*/routes/*86.29*/.Assets.at("js/utils.js")),format.raw/*86.54*/("""' type="text/javascript"></script>
        """),_display_(/*87.10*/javascripts),format.raw/*87.21*/("""
